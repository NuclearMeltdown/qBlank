...
const Entry kEntries[] = {
    // ---- general
    {Kind::Tab, kTabGeneral, nullptr, "Allgemein", "General",
     "Oberfläche|Interface|UI|Aussehen|Look|Programm|Program|Einstellungen|Preferences"},
    {Kind::Place, kTabGeneral, nullptr, "Sprache", "Language", nullptr},
    {Kind::Control, kTabGeneral, "language", "Sprache", "Language",
     "Deutsch|German|English|Englisch|Übersetzung|Translation"},
    {Kind::Place, kTabGeneral, nullptr, "Fenster", "Window", nullptr},
    {Kind::Control, kTabGeneral, "ownwindow", "Einstellungen in eigenem Fenster",
     "Settings in their own window",
     "Separates Fenster|Separate window|Abdocken|Undock|Popup"},
    {Kind::Place, kTabGeneral, nullptr, "Darstellung", "Appearance", nullptr},
    {Kind::Control, kTabGeneral, "theme", "Design", "Theme",
     "Dark mode|Dunkel|Hell|Light|Dark|Farbschema|Colour scheme|Nachtmodus|Look"},
    {Kind::Control, kTabGeneral, "accent", "Akzentfarbe", "Accent colour",
     "Accent color|Farbe|Colour|Color|Akzent|Highlight"},
    {Kind::Control, kTabGeneral, "customcolour", "Eigene Farbe", "Custom colour",
     "Custom color|Hex|RGB|Farbwähler|Colour picker|Color picker"},
    {Kind::Section, kTabGeneral, "traysec", "Infobereich", "Notification area",
     "Tray|Systray|System tray|Taskleiste|Taskbar|Uhr|Clock"},
    {Kind::Control, kTabGeneral, "tray", "Symbol im Infobereich", "Icon in the notification area",
     "Tray-Icon|Tray icon|Systray|Infobereich|Notification area|Symbol|Icon"},
    {Kind::Control, kTabGeneral, "trayitems", "Im Menü des Symbols", "In the icon's menu",
     "Schnellzugriff|Quick actions|Schnellaktionen|Tray-Menü|Tray menu|Befehle|Commands"},
    {Kind::Section, kTabGeneral, "shortcutsec", "Verknüpfungen", "Shortcuts",
     "Verknüpfung|Shortcut|Link|Startmenü|Start menu|Desktop|Symbol|Icon|Anheften|Pin"},
    {Kind::Control, kTabGeneral, "shortcutstart", "Ins Startmenü", "Add to the Start menu",
     "Startmenü|Start menu|Startmenue|Alle Apps|All apps|Programme|Programs|"
     "Startmenüverknüpfung|Start menu shortcut"},
    {Kind::Control, kTabGeneral, "shortcutdesktop", "Auf den Desktop", "Add to the desktop",
     "Desktop|Schreibtisch|Desktopverknüpfung|Desktop shortcut"},
    {Kind::Place, kTabGeneral, nullptr, "Sonstiges", "Other", nullptr},
    {Kind::Control, kTabGeneral, "log", "Protokoll schreiben", "Write a log",
     "Log|Logfile|Logdatei|Debug|Fehlersuche|Troubleshooting|Diagnose"},
    {Kind::Control, kTabGeneral, "logretention", "Alte Protokolle entfernen", "Remove old logs",
    ...
    {Kind::Control, kTabSource, "matchresolution", "Auflösung an die Videonorm anpassen",
     "Match the resolution to the video standard",
     "Autofix|automatisch|automatic|PAL|NTSC|720x576|720x480|passt nicht|does not fit|Norm"},
    ...
    {Kind::Tab, kTabDisplay, nullptr, "Anzeige", "Display",
     "Bildschirm|Screen|Monitor|Fenster|Window|Darstellung"},
    {Kind::Place, kTabDisplay, nullptr, "Grafik", "Graphics", nullptr},
    {Kind::Control, kTabDisplay, "vulkan", "Grafikschnittstelle", "Graphics API",
     "Vulkan|Direct3D|D3D11|DirectX|Grafik-API|Renderer|Backend|Neustart|Restart"},
